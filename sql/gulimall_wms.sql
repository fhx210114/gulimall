...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '采购信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wms_purchase
-- ----------------------------
INSERT INTO `wms_purchase` VALUES (9, NULL, NULL, NULL, NULL, 3, NULL, NULL, '2020-10-27 19:31:04', '2020-10-27 19:36:58');
...
-- ----------------------------
INSERT INTO `wms_purchase_detail` VALUES (11, 9, 6, 99, NULL, 1, 3);
...
CREATE TABLE `wms_ware_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '仓库信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wms_ware_info
-- ----------------------------
INSERT INTO `wms_ware_info` VALUES (1, '一号仓库', '北京', '1111');
INSERT INTO `wms_ware_info` VALUES (2, '二号仓库', '上海', '2222');
...
CREATE TABLE `wms_ware_sku`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '商品库存' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wms_ware_sku
-- ----------------------------
INSERT INTO `wms_ware_sku` VALUES (14, 6, 1, 99, '华为Mate30 Pro', 0);
