...
CREATE TABLE `pms_attr`  (
  ...
  `attr_name` char(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '属性名',
  `search_type` tinyint(4) NULL DEFAULT NULL COMMENT '是否需要检索[0-不需要，1-需要]',
  `icon` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '属性图标',
  `value_select` char(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '可选值列表[用逗号分隔]',
  ...
  `value_type` tinyint(255) NULL DEFAULT NULL,
  PRIMARY KEY (`attr_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '商品属性' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr
-- ----------------------------
INSERT INTO `pms_attr` VALUES (14, '入网型号', 1, 'xxx', 'A2404', 1, 1, 1449, 1, NULL);
INSERT INTO `pms_attr` VALUES (15, '机身长度（mm）', 1, 'xxx', '146.7', 1, 1, 1449, 1, NULL);
INSERT INTO `pms_attr` VALUES (16, 'CPU品牌', 1, 'xxx', 'Apple', 1, 1, 1449, 1, NULL);
INSERT INTO `pms_attr` VALUES (17, '产品名称', 1, 'xxx', 'iPhone 12;华为Mate30 Pro', 1, 1, 1449, 1, NULL);
INSERT INTO `pms_attr` VALUES (18, '上市年份', 0, 'xxx', '2020年', 1, 1, 1449, 0, NULL);
INSERT INTO `pms_attr` VALUES (19, '机身重量（g）', 1, 'xxx', '162', 1, 1, 1449, 1, NULL);
INSERT INTO `pms_attr` VALUES (20, '颜色', 0, 'xxx', '黑色;白色;绿色;红色', 0, 1, 1449, 0, NULL);
INSERT INTO `pms_attr` VALUES (21, '版本', 0, 'xxx', '128G;256G', 0, 1, 1449, 0, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '属性&属性分组关联' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr_attrgroup_relation
-- ----------------------------
INSERT INTO `pms_attr_attrgroup_relation` VALUES (18, 14, 9, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (19, 15, 10, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (20, 16, 11, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (21, 17, 9, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (22, 18, 9, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (23, 19, 10, NULL);
...
CREATE TABLE `pms_attr_group`  (
  ...
  `attr_group_name` char(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '组名',
  `sort` int(11) NULL DEFAULT NULL COMMENT '排序',
  `descript` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '描述',
  `icon` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '组图标',
  `catelog_id` bigint(20) NULL DEFAULT NULL COMMENT '所属分类id',
  PRIMARY KEY (`attr_group_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '属性分组' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr_group
-- ----------------------------
INSERT INTO `pms_attr_group` VALUES (9, '主体', 1, '主体信息', 'xxx', 1449);
INSERT INTO `pms_attr_group` VALUES (10, '基本信息', 2, '基本信息', 'xxx', 1449);
INSERT INTO `pms_attr_group` VALUES (11, '主芯片', 3, '芯片', 'xxx', 1449);
...
CREATE TABLE `pms_brand`  (
  ...
  `name` char(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '品牌名',
  `logo` varchar(2000) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '品牌logo地址',
  `descript` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL COMMENT '介绍',
  `show_status` tinyint(4) NULL DEFAULT NULL COMMENT '显示状态[0-不显示；1-显示]',
  `first_letter` char(1) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '检索首字母',
  `sort` int(11) NULL DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`brand_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '品牌' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_brand
-- ----------------------------
INSERT INTO `pms_brand` VALUES (3, '华为', 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-26/11/34a7c54e-95b6-4ec9-886b-08c09364db0c_huawei.png', '为我中华', 1, 'H', 1);
INSERT INTO `pms_brand` VALUES (4, '苹果', 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-26/11/3d25513b-1ab4-454b-86ea-8ae2406ecc11_timg.jpg', '贵不是它的缺点，那可能是您的缺带', 1, 'P', 2);
...
CREATE TABLE `pms_category`  (
  ...
  `name` char(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '分类名称',
  ...
  `sort` int(11) NULL DEFAULT NULL COMMENT '排序',
  `icon` char(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '图标地址',
  `product_unit` char(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '计量单位',
  `product_count` int(11) NULL DEFAULT NULL COMMENT '商品数量',
  PRIMARY KEY (`cat_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1450 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '商品三级分类' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_category
-- ----------------------------
INSERT INTO `pms_category` VALUES (1, '图书、音像、电子书刊', 0, 1, 1, 0, 'xx', 'xx', 0);
...
INSERT INTO `pms_category` VALUES (22, '电子书刊', 1, 2, 0, 0, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (23, '音像', 1, 2, 1, 0, 'xxx', '件', 0);
...
INSERT INTO `pms_category` VALUES (34, '手机通讯', 2, 2, 0, 0, NULL, NULL, 0);
...
INSERT INTO `pms_category` VALUES (165, '电子书', 22, 3, 0, 0, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (166, '网络原创', 22, 3, 0, 0, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (167, '数字杂志', 22, 3, 0, 0, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (168, '多媒体图书', 22, 3, 0, 0, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (169, '音乐', 23, 3, 1, 0, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (170, '影视', 23, 3, 0, 0, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (171, '教育音像', 23, 3, 0, 0, NULL, NULL, 0);
...
INSERT INTO `pms_category` VALUES (225, '手机', 34, 3, 0, 0, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (226, '对讲机', 34, 3, 0, 0, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (227, '合约机', 35, 3, 0, 0, NULL, NULL, 0);
...
INSERT INTO `pms_category` VALUES (251, '空调', 37, 3, 0, 0, NULL, NULL, 0);
...
INSERT INTO `pms_category` VALUES (324, '电动工具', 42, 3, 0, 0, NULL, NULL, 0);
...
INSERT INTO `pms_category` VALUES (342, '数码相机', 43, 3, 0, 0, NULL, NULL, 0);
...
INSERT INTO `pms_category` VALUES (449, '笔记本', 54, 3, 0, 0, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (450, '超极本', 54, 3, 0, 0, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (451, '游戏本', 54, 3, 1, 0, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (452, '平板电脑', 54, 3, 0, 0, NULL, NULL, 0);
INSERT INTO `pms_category` VALUES (453, '平板电脑配件', 54, 3, 0, 0, NULL, NULL, 0);
...
INSERT INTO `pms_category` VALUES (535, '炒锅', 62, 3, 0, 0, NULL, NULL, 0);
...
INSERT INTO `pms_category` VALUES (1447, 'FF', 23, 3, 0, 0, 'xx', '1', 0);
INSERT INTO `pms_category` VALUES (1448, '手机', 2, 2, 1, 0, '', '', NULL);
INSERT INTO `pms_category` VALUES (1449, '品牌手机', 1448, 3, 1, 0, '', '', NULL);
...
CREATE TABLE `pms_category_brand_relation`  (
  ...
  `catelog_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '品牌分类关联' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_category_brand_relation
-- ----------------------------
INSERT INTO `pms_category_brand_relation` VALUES (6, 4, 1449, '苹果', '品牌手机');
INSERT INTO `pms_category_brand_relation` VALUES (7, 3, 1449, '华为', '品牌手机');
...
CREATE TABLE `pms_comment_replay`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '商品评价回复关系' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_product_attr_value`  (
  ...
  `attr_id` bigint(20) NULL DEFAULT NULL COMMENT '属性id',
  `attr_name` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '属性名',
  `attr_value` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '属性值',
  `attr_sort` int(11) NULL DEFAULT NULL COMMENT '顺序',
  `quick_show` tinyint(4) NULL DEFAULT NULL COMMENT '快速展示【是否展示在介绍上；0-否 1-是】',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 55 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'spu属性值' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_product_attr_value
-- ----------------------------
INSERT INTO `pms_product_attr_value` VALUES (37, 7, 14, '入网型号', 'A2404', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (38, 7, 17, '产品名称', 'iPhone 12', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (39, 7, 18, '上市年份', '2020年', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (40, 7, 15, '机身长度（mm）', '146.7', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (41, 7, 19, '机身重量（g）', '162', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (42, 7, 16, 'CPU品牌', 'Apple', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (49, 6, 14, '入网型号', 'A2404', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (50, 6, 17, '产品名称', '华为Mate30 Pro', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (51, 6, 18, '上市年份', '2020年', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (52, 6, 15, '机身长度（mm）', '146.7', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (53, 6, 19, '机身重量（g）', '162', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (54, 6, 16, 'CPU品牌', 'Apple', NULL, 1);
...
CREATE TABLE `pms_sku_images`  (
  ...
  `img_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '图片地址',
  `img_sort` int(11) NULL DEFAULT NULL COMMENT '排序',
  `default_img` int(11) NULL DEFAULT NULL COMMENT '默认图[0 - 不是默认图，1 - 是默认图]',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 68 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'sku图片' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_images
-- ----------------------------
INSERT INTO `pms_sku_images` VALUES (31, 6, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-26/19//a428eae1-9368-4bc7-88ee-82dd8bf525d1_8bf441260bffa42f.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (32, 6, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-26/19//e9dcf4bf-784d-4775-8cef-26535e6d0aa9_28f296629cca865e.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (33, 6, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (34, 6, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (35, 6, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (36, 6, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (37, 7, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-26/19//a428eae1-9368-4bc7-88ee-82dd8bf525d1_8bf441260bffa42f.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (38, 7, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-26/19//e9dcf4bf-784d-4775-8cef-26535e6d0aa9_28f296629cca865e.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (39, 7, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (40, 7, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (41, 7, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (42, 7, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (43, 8, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (44, 8, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (45, 8, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (46, 8, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (47, 8, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (48, 8, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (49, 9, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (50, 9, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (51, 9, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (52, 9, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (53, 9, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-26/19//8f7622cf-8871-4d77-8f10-9d1abd0e74d0_73ab4d2e818d2211.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (54, 9, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-26/19//66439c46-0a43-4307-8b52-edd897418269_919c850652e98031.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (55, 10, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (56, 10, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (57, 10, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (58, 10, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (59, 10, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (60, 10, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (61, 11, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (62, 11, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (63, 11, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (64, 11, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (65, 11, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (66, 11, '', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (67, 12, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-27/09//fd540d07-983f-441d-8d8f-928ba3980ff2_1831cb31ecb63f24.jpg', NULL, 1);
...
CREATE TABLE `pms_sku_info`  (
  ...
  `sku_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT 'sku名称',
  `sku_desc` varchar(2000) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT 'sku介绍描述',
  `catalog_id` bigint(20) NULL DEFAULT NULL COMMENT '所属分类id',
  `brand_id` bigint(20) NULL DEFAULT NULL COMMENT '品牌id',
  `sku_default_img` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '默认图片',
  `sku_title` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '标题',
  `sku_subtitle` varchar(2000) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '副标题',
  `price` decimal(18, 4) NULL DEFAULT NULL COMMENT '价格',
  `sale_count` bigint(20) NULL DEFAULT NULL COMMENT '销量',
  PRIMARY KEY (`sku_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'sku信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_info
-- ----------------------------
INSERT INTO `pms_sku_info` VALUES (6, 6, '华为Mate30 Pro 黑色 128G', NULL, 1449, 3, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-26/19//a428eae1-9368-4bc7-88ee-82dd8bf525d1_8bf441260bffa42f.jpg', '华为Mate30 Pro 黑色 128G', '【华为官方直供/原装正品/现货速发】送：华为原装无线充+智能视窗保护套+蓝牙耳机+蓝牙音箱+钢化膜！购买mate30（5G版', 6099.0000, 0);
INSERT INTO `pms_sku_info` VALUES (7, 6, '华为Mate30 Pro 黑色 256G', NULL, 1449, 3, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-26/19//e9dcf4bf-784d-4775-8cef-26535e6d0aa9_28f296629cca865e.jpg', '华为Mate30 Pro 黑色 256G', '【华为官方直供/原装正品/现货速发】送：华为原装无线充+智能视窗保护套+蓝牙耳机+蓝牙音箱+钢化膜！购买mate30（5G版', 6399.0000, 0);
INSERT INTO `pms_sku_info` VALUES (8, 6, '华为Mate30 Pro 白色 128G', NULL, 1449, 3, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-26/19//8f7622cf-8871-4d77-8f10-9d1abd0e74d0_73ab4d2e818d2211.jpg', '华为Mate30 Pro 白色 128G', '【华为官方直供/原装正品/现货速发】送：华为原装无线充+智能视窗保护套+蓝牙耳机+蓝牙音箱+钢化膜！购买mate30（5G版', 6099.0000, 0);
INSERT INTO `pms_sku_info` VALUES (9, 6, '华为Mate30 Pro 白色 256G', NULL, 1449, 3, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-26/19//8f7622cf-8871-4d77-8f10-9d1abd0e74d0_73ab4d2e818d2211.jpg', '华为Mate30 Pro 白色 256G', '【华为官方直供/原装正品/现货速发】送：华为原装无线充+智能视窗保护套+蓝牙耳机+蓝牙音箱+钢化膜！购买mate30（5G版', 6399.0000, 0);
INSERT INTO `pms_sku_info` VALUES (10, 6, '华为Mate30 Pro 绿色 128G', NULL, 1449, 3, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-26/19//8a62c86f-e00b-423d-80bd-2b0066ac1846_23d9fbb256ea5d4a.jpg', '华为Mate30 Pro 绿色 128G', '【华为官方直供/原装正品/现货速发】送：华为原装无线充+智能视窗保护套+蓝牙耳机+蓝牙音箱+钢化膜！购买mate30（5G版', 6099.0000, 0);
INSERT INTO `pms_sku_info` VALUES (11, 6, '华为Mate30 Pro 绿色 256G', NULL, 1449, 3, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-26/19//8a62c86f-e00b-423d-80bd-2b0066ac1846_23d9fbb256ea5d4a.jpg', '华为Mate30 Pro 绿色 256G', '【华为官方直供/原装正品/现货速发】送：华为原装无线充+智能视窗保护套+蓝牙耳机+蓝牙音箱+钢化膜！购买mate30（5G版', 6399.0000, 0);
INSERT INTO `pms_sku_info` VALUES (12, 7, 'Apple iPhone 12 (A2404) 128GB 黑色 支持移动联通电信5G 双卡双待手机 黑色 128G', NULL, 1449, 4, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-27/09//fd540d07-983f-441d-8d8f-928ba3980ff2_1831cb31ecb63f24.jpg', 'Apple iPhone 12 (A2404) 128GB 黑色 支持移动联通电信5G 双卡双待手机 黑色 128G', '', 6599.0000, 0);
...
CREATE TABLE `pms_sku_sale_attr_value`  (
  ...
  `attr_name` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '销售属性名',
  `attr_value` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '销售属性值',
  `attr_sort` int(11) NULL DEFAULT NULL COMMENT '顺序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'sku销售属性&值' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_sale_attr_value
-- ----------------------------
INSERT INTO `pms_sku_sale_attr_value` VALUES (11, 6, 20, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (12, 6, 21, '版本', '128G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (13, 7, 20, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (14, 7, 21, '版本', '256G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (15, 8, 20, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (16, 8, 21, '版本', '128G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (17, 9, 20, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (18, 9, 21, '版本', '256G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (19, 10, 20, '颜色', '绿色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (20, 10, 21, '版本', '128G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (21, 11, 20, '颜色', '绿色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (22, 11, 21, '版本', '256G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (23, 12, 20, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (24, 12, 21, '版本', '128G', NULL);
...
CREATE TABLE `pms_spu_comment`  (
  ...
  `spu_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '商品名字',
  `member_nick_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '会员昵称',
  `star` tinyint(1) NULL DEFAULT NULL COMMENT '星级',
  `member_ip` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '会员ip',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `show_status` tinyint(1) NULL DEFAULT NULL COMMENT '显示状态[0-不显示，1-显示]',
  `spu_attributes` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '购买时属性组合',
  `likes_count` int(11) NULL DEFAULT NULL COMMENT '点赞数',
  `reply_count` int(11) NULL DEFAULT NULL COMMENT '回复数',
  `resources` varchar(1000) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '评论图片/视频[json数据；[{type:文件类型,url:资源路径}]]',
  `content` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL COMMENT '内容',
  `member_icon` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '用户头像',
  `comment_type` tinyint(4) NULL DEFAULT NULL COMMENT '评论类型[0 - 对商品的直接评论，1 - 对评论的回复]',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '商品评价' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_spu_images`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `spu_id` bigint(20) NULL DEFAULT NULL COMMENT 'spu_id',
  `img_name` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '图片名',
  `img_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '图片地址',
  `img_sort` int(11) NULL DEFAULT NULL COMMENT '顺序',
  `default_img` tinyint(4) NULL DEFAULT NULL COMMENT '是否默认图',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'spu图片' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_images
-- ----------------------------
INSERT INTO `pms_spu_images` VALUES (31, NULL, NULL, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-26/19//a428eae1-9368-4bc7-88ee-82dd8bf525d1_8bf441260bffa42f.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (32, NULL, NULL, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-26/19//e9dcf4bf-784d-4775-8cef-26535e6d0aa9_28f296629cca865e.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (33, NULL, NULL, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-26/19//8a62c86f-e00b-423d-80bd-2b0066ac1846_23d9fbb256ea5d4a.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (34, NULL, NULL, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-26/19//2e78829d-3536-4984-89f5-ab5f9f351c49_b5c6b23d01dcdf81.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (35, NULL, NULL, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-26/19//8f7622cf-8871-4d77-8f10-9d1abd0e74d0_73ab4d2e818d2211.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (36, NULL, NULL, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-26/19//66439c46-0a43-4307-8b52-edd897418269_919c850652e98031.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (37, NULL, NULL, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-27/09//fd540d07-983f-441d-8d8f-928ba3980ff2_1831cb31ecb63f24.jpg', NULL, NULL);
...
CREATE TABLE `pms_spu_info`  (
  ...
  `spu_name` varchar(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '商品名称',
  `spu_description` varchar(1000) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '商品描述',
  `catalog_id` bigint(20) NULL DEFAULT NULL COMMENT '所属分类id',
  `brand_id` bigint(20) NULL DEFAULT NULL COMMENT '品牌id',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'spu信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_info
-- ----------------------------
INSERT INTO `pms_spu_info` VALUES (6, '华为Mate30 Pro', '华为Mate30 Pro', 1449, 3, 1.0000, 0, '2020-10-26 11:45:11', '2020-10-26 11:45:11');
INSERT INTO `pms_spu_info` VALUES (7, 'Apple iPhone 12 (A2404) 128GB 黑色 支持移动联通电信5G 双卡双待手机', '5G新品，限量开抢】A14仿生芯片，6.1英寸超视网膜XDR显示屏，升维大提速，现实力登场！详情查看>', 1449, 4, 0.3500, 0, '2020-10-27 01:09:19', '2020-10-27 01:09:19');
...
CREATE TABLE `pms_spu_info_desc`  (
  ...
  `decript` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL COMMENT '商品介绍',
  PRIMARY KEY (`spu_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = 'spu信息介绍' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_info_desc
-- ----------------------------
INSERT INTO `pms_spu_info_desc` VALUES (6, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-26/19//fa579e83-2152-47b3-82ff-4dfe59d42d6d_73366cc235d68202.jpg,https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-26/19//8b080151-ffe8-4432-810d-dc5bcb1e5171_528211b97272d88a.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (7, 'https://gulimall-kites.oss-cn-beijing.aliyuncs.com/2020-10-27/09//6147d5da-8c9f-48cd-8080-4f9fbd13a11a_daa762696846709e (1).jpg');
